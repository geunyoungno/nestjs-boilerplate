import { handleMultipartMultipleFiles } from '#framework/file-upload/multipart/handler/multiple-files';
...
export function FilesInterceptor(fieldname: string, maxCount = 1, options?: TUploadOptions): Type<NestInterceptor> {
